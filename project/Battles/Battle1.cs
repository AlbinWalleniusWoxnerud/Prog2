...
namespace project
{
    class Battle1Method : Program
    {
        public static bool Battle1()
        {
            ...
            while (StaticPlayer.player.alive && StaticEnemies.goblin1.alive)
            {
                //Init vars
                ...
                switch (battle1_playerchoice)
                {
                    case 1:
                        ...
                        PlayerAttack(StaticEnemies.goblin1.health, StaticEnemies.goblin1.shield, StaticEnemies.goblin1.defense, out enemy_remaining_shield, out enemy_remaining_health);
                        StaticEnemies.goblin1.health = enemy_remaining_health;
                        StaticEnemies.goblin1.shield = enemy_remaining_shield;
                ...
                if (CheckIfWinner(StaticEnemies.goblin1.health)) return true;
                ...
                PlayerGetsAttacked(StaticEnemies.goblin1.crit, StaticEnemies.goblin1.attack, playerChooseDefend);

                //If there is a winner here the player lost therefore return false
                if (CheckIfWinner(StaticEnemies.goblin1.health)) return false;
            }
